...
3. Lambda sẽ trigger Stored Procedure trong Redshift
  -Lambda sẽ gọi 2 stored procedure là copy_from_s3 và transform
4. Load dữ liệu (EL) và Transform (T)
  -Redshift thực thi copy_from_s3
  -Sử dụng lệnh COPY để load dữ liệu từ S3 vào bảng staging
  -Redshift thực thi transform xử lý, làm sạch và tổng hợp dữ liệu thành dạng phục vụ phân tích
5. Visualization
QuickSight kết nối với Redshift thông qua VPC connection


Hiển thị các dashboard như sản phẩm bán chạy nhất
